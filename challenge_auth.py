...
def generate_challenge_frames():
    challenges = [
        "MOVE AWAY", "MOVE UP", "MOVE DOWN",
        "MOVE CLOSER", "MOVE LEFT", "MOVE RIGHT"
    ]
            ...
            while True:
                ...
                if time.time() - start_time > TIME_LIMIT:
                    ...
                    if attempts<max_attempts:
                        end_msg_time=time.time()+1.5
                        while time.time()<end_msg_time:
                            cv2.putText(frame, "TRY AGAIN", (130, 300),cv2.FONT_HERSHEY_SIMPLEX, 1.5, RED, 3)
